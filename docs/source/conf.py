...
# pysprk_kedro_demo documentation build
...
from pysprk_kedro_demo import __version__ as release

# -- Project information -----------------------------------------------------

project = "pysprk_kedro_demo"
author = "QuantumBlack"
...
htmlhelp_basename = "pysprk_kedro_demodoc"
...
latex_documents = [
    (
        master_doc,
        "pysprk_kedro_demo.tex",
        "pysprk_kedro_demo Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pysprk_kedro_demo",
        "Project pysprk_kedro_demo codebase.",
        "Data-Science",
    )
]
